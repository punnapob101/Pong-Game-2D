...
var colors = ['#66FF33', '#2ecc71', '#FFFF00', '#8c52ff', '#00FA9A'];
    ...
    update: function () {
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('คุณชนะนะจ๊ะ!!!!'); }, 1000);
            } else {
        ...
        // Check to see if the ai/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () { Pong.endGameMenu('คุณแพ้นะจ๊ะ!!!!'); }, 1000);
        }
    },
